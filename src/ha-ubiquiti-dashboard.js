...
const STYLE = [
  ...
  "ha-icon{width:18px;height:18px;color:var(--net-cyan)} .header-stats ha-icon{width:15px;height:15px}",
  ".topology{position:relative;isolation:isolate;padding:20px 20px 14px;min-height:300px}.wires{position:absolute;inset:0;z-index:0;pointer-events:none;overflow:visible}",
  ".wire{fill:none;stroke-width:3;stroke-linecap:round;stroke-linejoin:round;opacity:.8;filter:drop-shadow(0 0 4px currentColor)}.wire.cyan{stroke:var(--net-cyan);color:var(--net-cyan)}.wire.violet{stroke:var(--net-violet);color:var(--net-violet)}.wire.green{stroke:var(--net-green);color:var(--net-green)}.wire.amber{stroke:var(--net-amber);color:var(--net-amber)}.wire.blue{stroke:#6db7ff;color:#6db7ff}.wire.pink{stroke:#ff79c5;color:#ff79c5}",
  ".access-points{position:relative;z-index:1;display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:13px;align-items:stretch}",
  "button{font:inherit}.device{position:relative;display:flex;flex-direction:column;align-items:center;min-height:236px;padding:13px;border:1px solid var(--net-border);border-radius:16px;background:linear-gradient(150deg,rgba(17,48,64,.86),rgba(7,20,30,.9));color:var(--net-text);text-align:center;cursor:pointer;transition:transform .16s ease,border-color .16s ease,box-shadow .16s ease}.theme-light .device{background:linear-gradient(150deg,#fff,#edf8fb)}.device:hover,.switch-title:hover,.port:hover{border-color:var(--net-cyan);transform:translateY(-2px);box-shadow:0 8px 22px rgba(18,193,239,.12)}.device:focus-visible,.switch-title:focus-visible,.port:focus-visible{outline:2px solid var(--net-cyan);outline-offset:2px}",
  ".device-topline{display:flex;width:100%;align-items:center;justify-content:space-between;gap:8px;color:var(--net-muted);font-size:.66rem}.device-kind{display:inline-flex;align-items:center;gap:4px}.device-kind ha-icon{width:15px;height:15px}",
  ...
  ".ap-disc{position:relative;display:grid;place-items:center;width:90px;height:90px;margin:16px 0 11px;border:5px solid #eaf7fa;border-radius:50%;background:radial-gradient(circle at 40% 35%,#fff,#cfe2e7);box-shadow:0 0 0 2px rgba(77,227,155,.45),0 0 22px rgba(38,213,251,.36)}.ap-disc.offline{box-shadow:0 0 0 2px rgba(255,113,132,.5),0 0 20px rgba(255,113,132,.2)}.ap-disc.unknown{box-shadow:0 0 0 2px rgba(255,201,88,.5),0 0 20px rgba(255,201,88,.2)}.ap-disc span{color:#254555;font-size:2rem;font-weight:300}.ap-disc i{position:absolute;right:9px;bottom:10px;width:10px;height:10px;border:2px solid #efffff;border-radius:50%;background:var(--net-green)}.ap-disc.offline i{background:var(--net-red)}.ap-disc.unknown i{background:var(--net-amber)}",
  ".device-name{max-width:100%;overflow:hidden;color:var(--net-text);font-size:.96rem;font-weight:750;text-overflow:ellipsis;white-space:nowrap}.model{margin-top:3px;color:var(--net-muted);font-size:.72rem}.client-count{display:flex;align-items:center;gap:4px;margin-top:10px;color:var(--net-muted);font-size:.72rem}.client-count ha-icon{width:16px;height:16px}.client-count strong{color:var(--net-text);font-size:.9rem}.band-metrics{display:flex;flex-wrap:wrap;justify-content:center;gap:4px 10px;margin-top:7px;color:var(--net-muted);font-size:.68rem}.band-metrics strong{color:var(--net-green)}",
  ".uplink{position:relative;display:flex;align-items:center;gap:5px;margin-top:auto;padding-top:11px;color:var(--net-muted);font-size:.66rem}.uplink ha-icon{width:14px;height:14px}.wire-dot{position:absolute;width:9px;height:9px;border:2px solid var(--net-bg);border-radius:50%;box-shadow:0 0 8px currentColor}.uplink .wire-dot{left:50%;bottom:-18px;transform:translateX(-50%)}.wire-dot.cyan{background:var(--net-cyan);color:var(--net-cyan)}.wire-dot.violet{background:var(--net-violet);color:var(--net-violet)}.wire-dot.green{background:var(--net-green);color:var(--net-green)}.wire-dot.amber{background:var(--net-amber);color:var(--net-amber)}.wire-dot.blue{background:#6db7ff;color:#6db7ff}.wire-dot.pink{background:#ff79c5;color:#ff79c5}",
  ...
  ".switch-face{display:flex;align-items:center;gap:20px;min-height:123px;padding:24px 28px;background:linear-gradient(135deg,#d7e1e5,#f7fbfc 47%,#c8d4d9);color:#173542}.theme-light .switch-face{background:linear-gradient(135deg,#cbd7dc,#fff 47%,#d8e5e9)}.switch-brand{display:flex;flex-direction:column;align-items:center;gap:1px;min-width:46px}.switch-brand b{font-size:2.25rem;font-weight:400;line-height:.9}.switch-brand span{font-size:.43rem;font-weight:800;letter-spacing:.13em}.ports{display:grid;grid-template-columns:repeat(auto-fit,minmax(47px,1fr));flex:1;gap:9px}.port{position:relative;display:flex;flex-direction:column;align-items:center;gap:5px;min-width:0;padding:0;border:0;background:none;color:#193843;cursor:pointer}.port-connector{position:relative;display:flex;align-items:flex-end;justify-content:center;width:100%;height:43px;border:2px solid #395563;border-radius:6px;background:#071b25;box-shadow:inset 0 -10px #142e3b}.port.online .port-connector{border-color:#28c77e;box-shadow:0 0 9px rgba(40,199,126,.45),inset 0 -10px #142e3b}.port.offline .port-connector{border-color:#e66b78}.port.unknown .port-connector{border-color:#d69b37}.port-led{position:absolute;top:6px;left:7px;width:6px;height:6px;border-radius:50%;background:#657984}.port.online .port-led{background:#41e996;box-shadow:0 0 6px #41e996}.port.offline .port-led{background:#ff7184}.port.unknown .port-led{background:#ffc958}.port b{margin-bottom:6px;color:#b8d1d9;font-size:.67rem}.port em{position:absolute;right:3px;top:3px}.port em ha-icon{width:13px;height:13px;color:var(--net-amber)}.port-dot{top:-7px;left:50%;transform:translateX(-50%)}.port-name{display:flex;align-items:center;max-width:100%;gap:3px;color:#38515a;font-size:.62rem;line-height:1.15}.port-name ha-icon{width:13px;height:13px;color:#557781}.port-name span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.port small{color:#66818a;font-size:.58rem}",
  ...
  "@media(max-width:650px){.card-header{flex-direction:column;padding:18px}.header-stats{justify-content:flex-start}.topology{padding:14px}.switches{margin-top:18px}.wires{display:none}.switch-face{align-items:flex-start;padding:18px;gap:12px}.ports{grid-template-columns:repeat(4,minmax(43px,1fr));gap:8px}.switch-summary{display:none}.empty-state{margin:14px;padding:20px}footer{padding:10px 14px;flex-direction:column}.uplink .wire-dot{display:none}}",
].join("");
...
class UbiquitiNetworkDashboard extends HTMLElement {
  ...
  _port(port, switchName, portIndex) {
    ...
    label.append(icon(port.icon || "ethernet"), element("span", "", port.name || this._name(entityId, "Nicht belegt")));
    portButton.append(connector, label);
    if (port.speed_entity || port.speed) portButton.append(element("small", "", this._value(port.speed_entity || port.speed, "")));
    return portButton;
  }
  ...
  _drawWires() {
    ...
    this.querySelectorAll("[data-wire-from]").forEach((from) => {
      ...
      const middle = Math.max(y1 + 24, y1 + (y2 - y1) * 0.44);
